...
app.factory("services", ['$http', function ($http) {
    ...
    obj.insertarVoto = function (idalumno, idvoto) {
        return $http.get(serviceBase + 'insertar_voto?idalumno=' + idalumno + '&idvoto=' + idvoto);
    };
    ...
    obj.getEstadisticas = function (ncomision, distrito) {
        return $http.get(serviceBase + 'estadisticas?ncomision=' + ncomision + '&distrito=' + distrito);
    }
    ...
    obj.getPostulantes = function (ncomision) {
        return $http.get(serviceBase + 'ver_postulantes?ncomision=' + ncomision);
    }

    obj.getListarComisiones = function () {
    ...
    obj.tieneVoto = function (id) {
        return $http.get(serviceBase + 'tiene_voto?id=' + id);
    }
